...
He says it like he’s reading the weather—flat, factual, the old habit of a body that once served as a living lab bench.
...
They begin: *in, in, in—out, out.* The corridor seems to stretch and contract, an accordion made of lung tissue. At the third cycle, the amber node flares, then settles into a slower cadence that matches Sona’s two‑count exactly. A brief, mutual nod: the plexus accepting the compromise, for now.
...
They walk. The light narrows; the walls gather closer, warm as the inside of a throat. Breath steams, condenses, returns to them flavored with each others’ cortisol and faint citrus of Jian’s last dose of anti‑nausea lozenges. A strange intimacy, medicinal and unpremeditated.
...
Corv lifts an eyebrow. “Consent check. Do we proceed single file, or risk synchronous entry and whatever metaphor the plexus decides to make of our ribcages?”
...
Jian’s voice is dry telemetry over their mesh: “Peristaltic corridor’s dilating at 0.7 m per breath; we’re the bolus, so don’t linger in the sphincter.”  
...
Behind them, the bio‑lattice has already re‑threaded their footprints into an unmarked seam—no back‑trail, no receipt.  
