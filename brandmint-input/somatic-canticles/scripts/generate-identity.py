#!/usr/bin/env python3
"""
Somatic Canticles — Brand Identity (2B Seal + 2C Logo)
...
PROMPT_2B = """Somatic Canticles brand seal emblem. Metallic circular seal
...
PROMPT_2C = """Somatic Canticles embossed logo emboss. The brand sigil
...
PROMPT_LOGO_GLASS_CLASSIC = """Somatic Canticles logo mark study: Glass Classic.
Variant direction: glass classic. Material expression: indigo cathedral glass.
Build from the brand sigil logic: A Tryambakam-inspired triangulation glyph where three vectors resolve into an authored field of coherence. Premium identity object, centered composition, tactile lighting, deep-indigo and soma-gold palette discipline.
Render as a refined symbol exploration suitable for a collector-grade literary identity system.
No typography, no mockup scene, no packaging, no extra emblems beyond the core mark.
"""

PROMPT_LOGO_GLASS_FRACTURED = """Somatic Canticles logo mark study: Glass Fractured.
Variant direction: glass fractured. Material expression: fractured stained glass.
Build from the brand sigil logic: A Tryambakam-inspired triangulation glyph where three vectors resolve into an authored field of coherence. Premium identity object, centered composition, tactile lighting, deep-indigo and soma-gold palette discipline.
Render as a refined symbol exploration suitable for a collector-grade literary identity system.
No typography, no mockup scene, no packaging, no extra emblems beyond the core mark.
"""

PROMPT_LOGO_GLASS_GRADIENT = """Somatic Canticles logo mark study: Glass Gradient.
Variant direction: glass gradient. Material expression: indigo-to-violet glass gradient.
Build from the brand sigil logic: A Tryambakam-inspired triangulation glyph where three vectors resolve into an authored field of coherence. Premium identity object, centered composition, tactile lighting, deep-indigo and soma-gold palette discipline.
Render as a refined symbol exploration suitable for a collector-grade literary identity system.
No typography, no mockup scene, no packaging, no extra emblems beyond the core mark.
"""

PROMPT_LOGO_WAX_SEAL_BROKEN = """Somatic Canticles logo mark study: Wax Seal Broken.
Variant direction: broken wax seal. Material expression: cracked indigo wax with soma gold edge.
Build from the brand sigil logic: A Tryambakam-inspired triangulation glyph where three vectors resolve into an authored field of coherence. Premium identity object, centered composition, tactile lighting, deep-indigo and soma-gold palette discipline.
Render as a refined symbol exploration suitable for a collector-grade literary identity system.
No typography, no mockup scene, no packaging, no extra emblems beyond the core mark.
"""

PROMPT_LOGO_WAX_SEAL_CLASSIC = """Somatic Canticles logo mark study: Wax Seal Classic.
Variant direction: classic wax seal. Material expression: deep indigo wax seal.
Build from the brand sigil logic: A Tryambakam-inspired triangulation glyph where three vectors resolve into an authored field of coherence. Premium identity object, centered composition, tactile lighting, deep-indigo and soma-gold palette discipline.
Render as a refined symbol exploration suitable for a collector-grade literary identity system.
No typography, no mockup scene, no packaging, no extra emblems beyond the core mark.
"""

PROMPT_LOGO_WAX_SEAL_MELTING = """Somatic Canticles logo mark study: Wax Seal Melting.
Variant direction: melting wax seal. Material expression: molten indigo wax.
Build from the brand sigil logic: A Tryambakam-inspired triangulation glyph where three vectors resolve into an authored field of coherence. Premium identity object, centered composition, tactile lighting, deep-indigo and soma-gold palette discipline.
Render as a refined symbol exploration suitable for a collector-grade literary identity system.
No typography, no mockup scene, no packaging, no extra emblems beyond the core mark.
"""

PROMPT_LOGO_WAX_SEAL_SIGNET_RING = """Somatic Canticles logo mark study: Wax Seal Signet Ring.
Variant direction: signet ring impression. Material expression: signet-ring wax impression.
Build from the brand sigil logic: A Tryambakam-inspired triangulation glyph where three vectors resolve into an authored field of coherence. Premium identity object, centered composition, tactile lighting, deep-indigo and soma-gold palette discipline.
Render as a refined symbol exploration suitable for a collector-grade literary identity system.
No typography, no mockup scene, no packaging, no extra emblems beyond the core mark.
"""

PROMPT_LOGO_WAX_SEAL_TRIPLE = """Somatic Canticles logo mark study: Wax Seal Triple.
Variant direction: triple wax seal. Material expression: three interlocking indigo wax seals.
Build from the brand sigil logic: A Tryambakam-inspired triangulation glyph where three vectors resolve into an authored field of coherence. Premium identity object, centered composition, tactile lighting, deep-indigo and soma-gold palette discipline.
Render as a refined symbol exploration suitable for a collector-grade literary identity system.
No typography, no mockup scene, no packaging, no extra emblems beyond the core mark.
"""
...
def main():
    ...
    print("Models: Flux 2 Pro / Nano Banana Pro")
    print("=" * 60)
    ...
    print("\n--- LOGO-GLASS-CLASSIC: Logo Variant - Glass Classic (Nano Banana Pro) ---")
    gen_nano_banana("LOGO-GLASS-CLASSIC", "logo-glass-classic", PROMPT_LOGO_GLASS_CLASSIC, "1:1", image_urls)

    print("\n--- LOGO-GLASS-FRACTURED: Logo Variant - Glass Fractured (Nano Banana Pro) ---")
    gen_nano_banana("LOGO-GLASS-FRACTURED", "logo-glass-fractured", PROMPT_LOGO_GLASS_FRACTURED, "1:1", image_urls)

    print("\n--- LOGO-GLASS-GRADIENT: Logo Variant - Glass Gradient (Nano Banana Pro) ---")
    gen_nano_banana("LOGO-GLASS-GRADIENT", "logo-glass-gradient", PROMPT_LOGO_GLASS_GRADIENT, "1:1", image_urls)

    print("\n--- LOGO-WAX-SEAL-BROKEN: Logo Variant - Wax Seal Broken (Nano Banana Pro) ---")
    gen_nano_banana("LOGO-WAX-SEAL-BROKEN", "logo-wax-seal-broken", PROMPT_LOGO_WAX_SEAL_BROKEN, "1:1", image_urls)

    print("\n--- LOGO-WAX-SEAL-CLASSIC: Logo Variant - Wax Seal Classic (Nano Banana Pro) ---")
    gen_nano_banana("LOGO-WAX-SEAL-CLASSIC", "logo-wax-seal-classic", PROMPT_LOGO_WAX_SEAL_CLASSIC, "1:1", image_urls)

    print("\n--- LOGO-WAX-SEAL-MELTING: Logo Variant - Wax Seal Melting (Nano Banana Pro) ---")
    gen_nano_banana("LOGO-WAX-SEAL-MELTING", "logo-wax-seal-melting", PROMPT_LOGO_WAX_SEAL_MELTING, "1:1", image_urls)

    print("\n--- LOGO-WAX-SEAL-SIGNET-RING: Logo Variant - Wax Seal Signet Ring (Nano Banana Pro) ---")
    gen_nano_banana("LOGO-WAX-SEAL-SIGNET-RING", "logo-wax-seal-signet-ring", PROMPT_LOGO_WAX_SEAL_SIGNET_RING, "1:1", image_urls)

    print("\n--- LOGO-WAX-SEAL-TRIPLE: Logo Variant - Wax Seal Triple (Nano Banana Pro) ---")
    gen_nano_banana("LOGO-WAX-SEAL-TRIPLE", "logo-wax-seal-triple", PROMPT_LOGO_WAX_SEAL_TRIPLE, "1:1", image_urls)
