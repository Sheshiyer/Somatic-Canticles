#!/usr/bin/env python3
"""
Somatic Canticles — Campaign Posters (8A + 9A + 10A-C)
...
PROMPT_8A = """Somatic Canticles "THE SEEKER" brand presence poster.
...
PROMPT_9A_BASE = """Somatic Canticles campaign poster. Single {object} centered on
...
The object rendered as physical brand artifact
artifact -- part {material_a}, part {material_b}, with subtle accent light trails
glowing Neuronal White (#F5F5F0). Clean minimal border frame in
Soma Gold (#D4AF37). Typography bottom third: "{engine_name}" in
Avenir Next Bold, all caps, Neuronal White (#F5F5F0).
Below: "{tagline}" in Avenir Next Light, Axon Gray (#6B6B6B).
Bottom: "Somatic Canticles" in Charter Regular. Dramatic top-down spotlight. 8K."""

PROMPT_10_BASE = """Somatic Canticles "{sequence_title}" sequential brand narrative.
SPEC LOCK: Depict only Somatic Canticles Trilogy Hardcover Set. Exact physical form: Three hardcover volumes — Anamnesis Engine, The Myocardial Chorus, and The Ripening — with deep indigo jackets, Soma Gold foil, and sacred anatomy cover art.. Signature color anchor: Deep Neural Indigo (#1A1F3A). Detail focus: Gold foil glyphs, Tarot numerics, sacred anatomy cover systems, and indigo-to-violet transformations across the trilogy.. Allowed accessories only: three hardcover volumes, annotated sacred anatomy spread, wax-seal brand mark, triangulation-engine diagram sheet, marginalia notebook. Hard bans: robotic hard-surface body. Match the uploaded product reference photos exactly in silhouette, face details, materials, ports, and included accessories.
3x3 grid of 9 panels showing lifestyle-focused progression.
No face -- only hands and forearms. Same hands across all 9 panels.
Environment: Deep-indigo studio environments, atlas pages, luminous biology, and restrained sacred geometry. Materials: deep indigo cloth boards, soma gold foil, sacred anatomy linework, anatomical atlas paper, luminous neuronal filaments, wax seal insignia, neural network tracery, cardiac waveform overlays, tarot panel borders, marginalia notebook stock.
9 PANELS: {panel_descriptions}
Camera: Editorial macro direction, 80mm equivalent, deep blacks with gold-edge rim light. Soma Gold (#D4AF37) highlights,
Deep Neural Indigo (#1A1F3A) deep shadows. 2px Axon Gray borders. 8K."""
