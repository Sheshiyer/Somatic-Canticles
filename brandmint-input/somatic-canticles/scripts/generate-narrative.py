#!/usr/bin/env python3
"""
Somatic Canticles — Narrative Assets
...
PROMPT_7A = """Somatic Canticles editorial contact sheet. 3x3 grid, 9 panels,
...
PROMPT_EMAIL_HERO = """Somatic Canticles email header hero image. 600px wide landscape composition.
PRODUCT: Somatic Canticles Trilogy Hardcover Set -- Three hardcover volumes — Anamnesis Engine, The Myocardial Chorus, and The Ripening — with deep indigo jackets, Soma Gold foil, and sacred anatomy cover art..
The product must match the reference photos exactly. Do NOT substitute with any other device.
SPEC LOCK: Depict only Somatic Canticles Trilogy Hardcover Set. Exact physical form: Three hardcover volumes — Anamnesis Engine, The Myocardial Chorus, and The Ripening — with deep indigo jackets, Soma Gold foil, and sacred anatomy cover art.. Signature color anchor: Deep Neural Indigo (#1A1F3A). Detail focus: Gold foil glyphs, Tarot numerics, sacred anatomy cover systems, and indigo-to-violet transformations across the trilogy.. Allowed accessories only: three hardcover volumes, annotated sacred anatomy spread, wax-seal brand mark, triangulation-engine diagram sheet, marginalia notebook. Hard bans: robotic hard-surface body. Match the uploaded product reference photos exactly in silhouette, face details, materials, ports, and included accessories.
Warm Soma Gold (#D4AF37) lighting. Deep Neural Indigo (#1A1F3A) tonal background.
Brand mark: A Tryambakam-inspired triangulation glyph where three vectors resolve into an authored field of coherence. Materials: deep indigo cloth boards, soma gold foil, sacred anatomy linework, anatomical atlas paper, luminous neuronal filaments, wax seal insignia, neural network tracery, cardiac waveform overlays, tarot panel borders, marginalia notebook stock. Clean, inviting. 8K."""
