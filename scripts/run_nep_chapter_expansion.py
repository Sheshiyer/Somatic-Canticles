...
LEXICAL_REPLACEMENTS = (
    ...
    ("paradise", "refuge"),
    ("Paradise", "Refuge"),
    ("living tapestry", "living pattern"),
    ("Living tapestry", "Living pattern"),
    ("armor", "cover"),
    ("Armor", "Cover"),
    ("planet", "world"),
    ...
    ("Utopia", "Too-perfect order"),
    ("One day there would be", "Later, there might be"),
    ("one day there would be", "later, there might be"),
    ("other severed teams", "other lives"),
    ("Other severed teams", "Other lives"),
    ("Sora", "Sona"),
...
CHAPTER_CAST_HINTS = {
    ...
    21: (
        "For Chapter 21, keep named people limited to Corv, Sona, Jian, Gideon, Mira Verath, and Anvel Verath as a historical wound coordinate only. "
        "Mira Verath may appear only as proof case, data trace, lineage lattice, or review consequence; Anvel Verath may appear only as the remembered origin point, not an on-page speaker. "
    ...
    27: (
        "For Chapter 27, keep named people limited to Corv, Sona, Jian, and Gideon. "
        "Do not invoke Mira Verath, Anvel Verath, or The Gardener on page; the final chapter belongs to the live four and the first habitable relation. "
        "Bridge/contact language may appear only as a distant bounded horizon, not as new speakers, sequel bait, Noetic Network naming, or a solved planetary society. "
        "No new operators, assistants, monitors, House envoys, House delegates, named officials, or extra spoken roles."
    ),
    11: (
...
def chapter_insert_guidance(chapter_number: int) -> str:
    ...
    if chapter_number == 21:
        return (
            "Chapter 21 insertion lane: inherit accepted Chapter 20 convergence visibility and enact only the first controlled hostile-contact Test Fire. "
            "The test may expose the held field to one bounded pressure/contact window, but it must not cross, enter, sever, complete passage, or begin Chapter 22's individualized temptation logic. "
            "The Gardener may register only as hostile load, pressure, or correction attention; do not add Gardener dialogue, image-body, explanation, or sermon. "
            "Do not present the Test Fire as solved, complete, mastered, salvific, or as merger/fusion/unity of the team. "
    ...
    if chapter_number == 27:
        return (
            "Chapter 27 insertion lane: inherit Chapter 26's practiced conditions and stabilize only the first habitable home. "
            "The chapter may deepen rhythm, first ground, first tree, shared rest, and a bounded horizon toward future relation, but must not become utopia, coronation, omnipotence, planetary society, or sequel teaser. "
            "Keep four final arc landings role-bound: Corv witnesses without imposing meaning, Sona channels aliveness without flooding, Jian allows living system/paradox without rigid map, and Gideon guards passage without fortress logic. "
            "Use source motifs only as submerged scene behavior: first step before justification, fewer frameworks than lived access, and relationship as practice rather than slogan. "
            "Do not name tarot roles, cards, Thoth/Crowley, runtime-access essays, Noetic Network, new teams, or explicit symbolic scaffold. "
            "End as breathable first habitation: enough for rest and continuity, not complete, final, or triumphant."
        )
